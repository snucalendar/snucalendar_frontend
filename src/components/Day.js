...
class Day extends Component {
  ...
  render() {
    ...
    return (
      <a style={{gridColumnStart : colStart, width : '150px', height: '160px', border: '0.01px solid #A57E7E', cursor : (this.props.events.length ? 'pointer' : 'default')}} onClick={this.toggleDayEventList}>
